...
export default function Dropdown() {
    ...
    <div>
        <span style={{ fontWeight: 'bold' }}>You selected</span> <span style={{ fontWeight: 'bold',fontSize:11 }}>{selectedOption}</span>, <span style={{textShadow: '1px 1px 2px rgba(0, 0, 0, 0.5)'}}>{selectedStateOption}, {selectedCityOption}</span>
    </div>
)}
        </div>
    );
